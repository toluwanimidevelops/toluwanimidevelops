...
const ProjectCard = ({ img, link, year, title, thing, description, languages }) => {
  return (
    <a target="_blank" href={link} className="w-full  group overflow-hidden rounded-3xl bg-gradient-to-b from-[#0f0f10] to-transparent rounded-xl border border-[#b0b0b5]/20 transition-all duration-500 hover:border-blue-700 hover:from-blue-600/10 hover:to-transparent cursor-pointer">
      ...
      <div className="w-full  p-7">
        <h1 className="text-xl pb-2 font-secondary flex justify-between text-white">
          {title}{" "}
          <MdArrowOutward
        ...
        <p className="font-main text-[#b0b0b5] text-[14px] pb-5 ">
          {description}
        </p>
...
const Project = () => {
  return (
    <div id="work" className="mt-20 md:mt-36">
      ...
      <div className="lg:grid-cols-2 my-15 gap-4 grid-cols-1 grid">
        <ProjectCard
