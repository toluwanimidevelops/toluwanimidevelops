...
const Nav = ({ children }) => {
  ...
  return (
    <div className="relative min-h-screen">
      {/* Navigation Header */}
      <nav
        className={`fixed py-5 top-0 left-0 w-full   z-50 transition-all duration-300 ease-in-out ${
          isScrolled
            ? "bg-[#0a0a0b]/30 py-6 border-b border-[#bebec4]/30 backdrop-blur-md "
            : "bg-transparent"
        }`}
      >
        <div className="flex items-center justify-between max-w-[1350px] px-5  mx-auto">
          {/* Logo */}
          <a
            href="/"
